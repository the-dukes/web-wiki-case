import{_ as n,o as s,c as a,a as e}from"./app-72013311.js";const t={},p=e(`<h1 id="_02-递归-预编译" tabindex="-1"><a class="header-anchor" href="#_02-递归-预编译" aria-hidden="true">#</a> 02-递归，预编译</h1><h2 id="js-运行三部曲" tabindex="-1"><a class="header-anchor" href="#js-运行三部曲" aria-hidden="true">#</a> js 运行三部曲</h2><ol><li>语法分析：扫描但不执行</li><li>预编译</li><li>解释执行</li></ol><h2 id="预编译" tabindex="-1"><a class="header-anchor" href="#预编译" aria-hidden="true">#</a> 预编译</h2><p>预编译发生在<strong>函数执行的前一刻</strong>。解决执行顺序问题 。</p><h3 id="预编译前奏" tabindex="-1"><a class="header-anchor" href="#预编译前奏" aria-hidden="true">#</a> 预编译前奏</h3><p><strong>函数声明整体提升：</strong></p><p>函数不管写到哪里，都会被提到逻辑的最前面。</p><p><strong>变量声明提升：</strong></p><ul><li>变量 声明提升</li></ul><p>把 var a 提升到最前面。</p><ul><li>var a = 123;这是变量声明再赋值</li></ul><p>变量声明提升是把他拆分成 <code>var a; a = 123;</code>然后把 var a 提升到最前面。</p><p><strong>案例：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>例：
function test(){
    console.log(‘a’);
}
test();     // 上面能执行
